# The name of this view in Looker is "Result Pipeline Iwmovimento"
view: result_pipeline_iwmovimento {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `testelooker_7yhfoaw4c7m1.ResultPipelineIWMovimento`
    ;;
